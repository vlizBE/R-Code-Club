...
include_graphics("H:/Rcodeclub_mails/Session 5/images/image2.png")
```
...
During the last R Code Club meeting we agreed to start a newsletter including the topics discussed during the meetings for everyone who could not assist to follow up. We hope it will help to spread the word about these meetings and encourage anyone interested in R programming to join us!
...
include_graphics("H:/Rcodeclub_mails/Session 5/images/image5.png")
```
...
```{r, out.width = perc_img, fig.align = "center", eval=FALSE}
include_graphics("H:/Rcodeclub_mails/Session 5/images/image3.png")
```

Here at the R Code Club we are setting up a little project to estimate the impact of our data systems by looking at the citations. Who is using (and citing) our data systems? Where do they come from? From which research disciplines are they? This tool would assist in visualizing the scope of our products and services, which is specially interesting for the policy division, creating reports or applying for grants.

We are currently working in the script to scrap the citations from the web, as well as in the application. This is an app to be used by everyone interested, so we will be more than happy to hear your ideas, proposal and wishes in rcodeclub@vliz.be
...
Our next meeting will be focused on [Shiny apps!](https://shiny.rstudio.com). Shiny is an R package for developing interactive web application just by using R. This and more topics will be discussed the next 2019-10-18 at 14:00 CET in the [meeting room IODE TR1](https://goo.gl/maps/84nY6un5qGDyv3Mr9)
...
include_graphics("H:/Rcodeclub_mails/Session 5/images/image4.png")
```
</center>
&nbsp;
&nbsp;
